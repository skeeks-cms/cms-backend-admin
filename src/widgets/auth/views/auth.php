 ...
 * @var $widget \skeeks\cms\admin\widgets\auth\AuthWidget
 */
...
JS
        ...
        <?php if ($widget->is_allow_auth_by_email) : ?>
...
JS
        ...
        <div class="form-group sx-auth-visually-hidden">
        ...
        <div class="form-group">
            <div class="input-group">
                <button
                    ...
                    type="button"
                    data-sx-auth-password-toggle
                    aria-label="<?= \Yii::t('skeeks/cms', 'Show password') ?>"
                    aria-pressed="false"
    ...
    function (ActiveFormAjaxSubmit) {
        ActiveFormAjaxSubmit.on('success', function(e, response) {
            if (response.data.type == 'password') {
                ...
                $("[data-action=auth-by-email-code] .sx-email", jAuthWidget).val(response.data.email);
...
JS
    ...
    <div class="sx-auth-action" data-action="auth-by-email-code">
        ...
        <input type="hidden" name="email" class="sx-email" />
        <div class="form-group">
            <input type="text"
                   name="email_code"
    ...
    <div class="text-center">
        <?php if (isset(\Yii::$app->authClientCollection) && \Yii::$app->authClientCollection->clients) : ?>
