...
(function (sx, $, _) {
    sx.classes.Auth = sx.classes.Component.extend({
        ...
        _onDomReady: function () {
            ...
            self.getJWrapper().on("click", "[data-sx-auth-password-toggle]", function () {
                var jToggle = $(this);
                var jInput = jToggle.siblings("input[type=password], input[type=text]").first();
                var jIcon = $("i", jToggle);
                var isVisible = jInput.attr("type") === "text";

                jInput.attr("type", isVisible ? "password" : "text");
                jToggle.attr("aria-pressed", isVisible ? "false" : "true");
                jIcon.toggleClass("fa-eye", isVisible);
                jIcon.toggleClass("fa-eye-slash", !isVisible);
            });
        ...
        stopEmailLeftTime() {
            var self = this;
            var waitJwrappper = $(".sx-email-trigger-wrapper", self.getJWrapper());
        ...
        stopPhoneLeftTime() {
            var self = this;
            var waitJwrappper = $(".sx-phone-trigger-wrapper", self.getJWrapper());
        ...
        stopCallcheckPhoneLeftTime() {
            var self = this;
            var waitJwrappper = $(".sx-callcheck-phone-trigger-wrapper", self.getJWrapper());
        ...
        runAction: function (data) {
            ...
            $(".sx-auth-action", self.getJWrapper()).hide();
            $(".sx-auth-action[data-action=" + action + "]", self.getJWrapper()).show();
